namespace ServiceAbstractionLayer
{
	public interface IQuizService
	{
        ...
        Task<IEnumerable<QuizForStudentResponseDto>> GetAllQuizzesForCourseAsStudentAsync(int courseId, string studentId, CancellationToken cancellationToken = default);
